...
export function Render() {
    if (!isInitialized || !wizProtocol || !AutoStartStream) {
        return;
    }

    let [r, g, b] = getRgbValues();
    let brightnessPercent = device.getBrightness();
    let wizBrightness = calculateWizBrightness(brightnessPercent);
...
function getRgbValues() {
    if (forceColor && controller.isRGB) {
        return device.hexToRgb(forcedColor);
    }
    return device.color(0, 0);
}

function calculateWizBrightness(brightnessPercent) {
    ...
    return Math.min(MAX_WIZ_BRIGHTNESS, wizBrightness);
}
...
const WIZDeviceLibrary = {
    "ESP01_SHDW_01": {
        productName: "WIZ Smart Plug",
        imageUrl: "",
        supportRGB: false,
        supportDimming: false,
        supportWhiteColor: false,
        ledCount: 0
    },
    "ESP03_SHRGB3_01": {
    ...
    "ESP15_SHTW_01I": {
        productName: "WIZ Tunable White A60 E27",
        imageUrl: "",
        supportRGB: false,
        supportDimming: true,
        supportWhiteColor: true,
    ...
    "ESP06_SHRGB_01": {
        productName: "WIZ Color A60 E27",
        imageUrl: "https://www.assets.signify.com/is/image/PhilipsLighting/9290023835-IMS-en_SG?wid=400&hei=400&$pnglarge$",
        supportRGB: true,
        supportDimming: true,
        supportWhiteColor: true,
        ledCount: 1
    ...
    "ESP20_SHRGBW_01B": {
        productName: "WIZ Squire Table Lamp",
        imageUrl: "",
        supportRGB: true,
        supportDimming: true,
        supportWhiteColor: true,
    ...
    "default": {
        productName: "Unknown WIZ Device",
        imageUrl: "",
        supportRGB: false,
        supportDimming: true,
        supportWhiteColor: false,
